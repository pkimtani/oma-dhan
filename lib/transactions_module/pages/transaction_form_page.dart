...
import 'package:apps/core/widgets/picker_form_row.dart';
    ...
    return RepositoryProvider.value(
      ...
      child: RepositoryProvider(
        create: (context) => UserRepository(
          localDB: context.read<DatabaseCubit>().state,
        ),
                      ...
                      BlocListener<TransactionFormBloc, TransactionFormState>(
                          ...
                          listenWhen: (previous, current) {
                            return (previous.transactionFormStatus !=
                                    current.transactionFormStatus) &&
                                current
                                    .transactionFormStatus.isSavedSuccessfully;
                          },
                          listener: (context, state) {
                        ...
                        children: [
                          ...
                          CupertinoFormSection.insetGrouped(
                            children: [
                              ...
                              TextFieldFormRow(
                                placeholder:
                                    'Ex: Bought extra milk for the week',
